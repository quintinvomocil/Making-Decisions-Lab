...
let lovesCode = true;
  ...
  if (lovesCode = false){
    ...
    else console.log ("I love to code.");
...
if ( temperature >= 80 && rain === true ){
  ...
  rain = false;
        ...
        if ( temperature >= 80 && rain === false ){
          console.log("You should wear a t-shirt and you don't need an umbrella.");
      }
          else if ( temperature > 60 && temperature < 80 && rain === false ){
            console.log("You should wear a normal jacket.");
          }
            else (temperature < 60)
              console.log("You should wear a jacket and don't need an umbrella.");
